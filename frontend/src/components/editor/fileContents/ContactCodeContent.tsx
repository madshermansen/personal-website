export default function ContactCodeContent() {
  return (
    <div className="font-mono text-xs whitespace-nowrap">
      ...
      <div className="leading-relaxed"><span className="monokai-property">personal</span><span className="text-text/70">:</span></div>
      ...
      <div className="leading-relaxed"></div>
      <div className="leading-relaxed"><span className="monokai-property">social</span><span className="text-text/70">:</span></div>
      <div className="ml-4 leading-relaxed"><span className="monokai-property">github</span><span className="text-text/70">:</span></div>
      <div className="ml-8 leading-relaxed"><span className="monokai-property">username</span><span className="text-text/70">: </span><span className="monokai-string">&quot;madshermansen&quot;</span></div>
      <div className="ml-8 leading-relaxed"><span className="monokai-property">url</span><span className="text-text/70">: </span><span className="monokai-string">&quot;https://github.com/madshermansen&quot;</span></div>
      <div className="leading-relaxed"></div>
      <div className="ml-4 leading-relaxed"><span className="monokai-property">linkedin</span><span className="text-text/70">:</span></div>
