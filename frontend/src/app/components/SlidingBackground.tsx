...
export default function SlidingBackground() {
  ...
  return (
    ...
    >
      <motion.div
        className="grid h-screen overflow-hidden place-items-center absolute bg-background select-none z-10"
        style={{
          width,
          overflow: "hidden",
        }}
      >
        <h1 className="fancy sm:text-6vw text-5xl leading-tight m-10-screen w-80vw text-center font-bold">
          ...
          <span className="fancy text-primary font-normal sm:text-8vw text-7xl">
            Skill
          </span>
        </h1>
      </motion.div>
      ...
      <div className="grid h-screen overflow-hidden place-items-center absolute w-full bg-primary">
        <h1 className="fancy sm:text-6vw text-5xl leading-tight m-10-screen w-80vw text-center text-background font-bold">
          Making something great should take{" "}
          <span className="fancy text-white font-normal sm:text-8vw text-7xl">
            Effort
          </span>
        </h1>
      </div>
